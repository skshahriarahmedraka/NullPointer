<script lang="ts">
	...
	import type { CookieInfo1Type, QuesArrWithMetadataType, UserDataType } from '$lib/store/types';
	import { fetchUserData } from '$lib/store/fetch';
	import { StoredSearchedString, UserData } from '$lib/store/store';
	...
	let { SearchedString } = data;
	console.log("🚀 ~ file: +page.svelte:22 ~ SearchedString:", SearchedString)
	StoredSearchedString.set(SearchedString);
