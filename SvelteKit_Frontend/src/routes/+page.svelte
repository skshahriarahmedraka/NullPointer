...
{#if loadingState}
	<div class="z-40   flex w-full flex-row justify-center bg-[#181818] ">
		<Navbar />
		<!-- COLLECTIVE -->
		<Collectives />
		<!-- QUESTION LIST -->
		...
		<!-- settings -->
		<div class=" mt-12 max-h-full min-h-screen  w-[1200px] bg-[#2d2d2d]  ">
			<div class="flex flex-row ">
				<!-- questions -->
				<div class="flex w-[850px] flex-col">
					<!-- public ques & ask -->
					<div class=" mt-3  flex h-16  w-full flex-row ">
